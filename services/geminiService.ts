...
export const generateScript = async (prompt: string): Promise<string> => {
  ...
  const response = await ai.models.generateContent({
    model,
    contents: `You are an expert screenwriter and visual director. 
    Help me refine this idea into a detailed visual description suitable for video generation. 
    Keep it concise but descriptive, focusing on lighting, camera movement, and subject details.
