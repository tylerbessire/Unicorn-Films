...
const Timeline: React.FC<TimelineProps> = ({
  ...
  return (
    <div className="h-64 bg-[#121212] border-t border-gray-800 flex flex-col shrink-0">
      <div className="h-10 bg-[#1c1c1e] border-b border-gray-800 flex items-center px-4 justify-between">
